...
import static com.tagtraum.perf.gcviewer.view.UnittestHelper.getResourceAsString;
...
public class TestGCModelLoaderController {
    ...
    public void openString() throws Exception {
        ...
        controller.open(new GcResourceFile(getResourceAsString(OPENJDK, "SampleSun1_6_0CMS.txt")));
    ...
    public void openAsSeries() throws Exception {
        assertThat("number of gcdocuments before", controller.getGCViewerGui().getDesktopPane().getAllFrames().length, is(0));
        List<GCResource> gcResourceList = getGcResourcesForSeries();
    ...
    private List<GCResource> getGcResourcesForSeries() throws IOException {
    ...
    public void dropOnDesktopPane() throws Exception {
        ...
        fileList.add(new File(getResource(OPENJDK, "SampleSun1_6_0G1_MarkStackFull.txt").getPath()));
    ...
    public void open_File() throws Exception {
        File file = new File(getResourceAsString(OPENJDK, "SampleSun1_6_0CMS.txt"));
    ...
    public void open_GcResourceFile() throws Exception {
        GCResource resource = new GcResourceFile(getResourceAsString(OPENJDK, "SampleSun1_6_0CMS.txt"));
